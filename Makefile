...
CFLAGS=-Wall -Wno-unused-result -Wno-unknown-pragmas -Wfatal-errors -fPIC -rdynamic
...
COMMON+= -DNUMPY -I/usr/include/python3.6m/ -I/usr/lib/python3.6m/dist-packages/numpy/core/include/numpy/
CFLAGS+= -DNUMPY
endif
